...
<br/> url 도메인을 통해서 https://siteproject22.online을 작성할 경우 nginx에서 location /로 next.js url과 연결하고,
...
### 알람 기능(게시판에 댓글을 달 경우 해당 게시판의 게시글 작성자가 어느 페이지에서건 "새로운 글이 작성되었습니다."라고 알림)
> https://github.com/xron2626/recent-board-project/assets/133539339/262d10ed-b2c8-43c3-938a-e1922b34f038


### 쪽지 기능(해당 알람이 발생한 이후, 우측 상단의 메일함 같은 곳을 클릭하면 작성자에게 발생한 알림을 모아놓은 쪽지 리스트의 페이지가 나타남)

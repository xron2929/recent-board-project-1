...
public class CommentService {
    ...
    // 이거 데이터 수정해야됨
    public void saveParentComment(CommentSaveViewDto commentViewDto) throws Exception {
        ParentComment comment = commentMapper.saveMemberAndComment(commentViewDto);
